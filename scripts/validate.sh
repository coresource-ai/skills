...
python3 -m json.tool "$ROOT_DIR/plugins/spec-writer/.codex-plugin/plugin.json" >/dev/null
...
test -f "$ROOT_DIR/.agents/plugins/marketplace.json"
test -f "$ROOT_DIR/.claude-plugin/plugin.json"
test -f "$ROOT_DIR/.claude-plugin/marketplace.json"
test -f "$ROOT_DIR/plugins/spec-writer/.codex-plugin/plugin.json"
test -f "$ROOT_DIR/plugins/spec-writer/skills/spec-writer/SKILL.md"
